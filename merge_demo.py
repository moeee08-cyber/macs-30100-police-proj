...
df1 = pd.read_csv('demo.csv', low_memory=False)
df2 = pd.read_csv('edu_attain.csv', low_memory=False)
df3 = pd.read_csv('employ.csv', low_memory=False)
df4 = pd.read_csv('mean_income.csv', low_memory=False)
df5 = pd.read_csv('race.csv', low_memory=False)
